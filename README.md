...
The dataset can be found [here]("./additional_experimets/data") and the following description can be used to get the audio, the respective transcripts and also the information on the chapters.
