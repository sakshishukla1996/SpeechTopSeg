...
checkpoint = "/data/euronews_dataset/weights/transcript/monolingual_text/de_de_de/de_de_de.ckpt"  # Best checkpoint

# Chnage audio_dataset with transcript embedding dataset for evaluating on transcript.
input_root = "/data/euronews_dataset/transcript_embedding_dataset/test_data/de"

output_root = Path("/data/euronews_dataset/weights/transcript/monolingual_text/de_de_de/predictions/")
